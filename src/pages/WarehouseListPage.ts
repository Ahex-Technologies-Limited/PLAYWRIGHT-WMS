...
export class WarehouseListPage extends BasePage {
  ...
  public warehouseType = `//p-dropdown[@formcontrolname='type']`;
  ...
  public warehouseManager = `//p-dropdown[@formcontrolname='manager_id']`;
  ...
  public specialEquipment = `(//input[@type='text' and contains(@class, 'p-element') and @placeholder='Enter'])[2]`;
  public temperatureControl = `//p-dropdown[@formcontrolname='temperature_controlled']`;
  public dockingStation = '#dockingStations';
  public securityFeatures = "(//input[@type='text' and contains(@class, 'p-element') and @placeholder='Enter'])[1]";
  public unitOfMeasurement = "//p-multiselect[@formcontrolname='unit_of_measure_ids']";
  public defaultPickTaskType = `//p-dropdown[@formcontrolname='default_pick_type']`;
