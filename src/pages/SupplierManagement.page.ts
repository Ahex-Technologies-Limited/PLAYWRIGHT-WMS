...
export class SupplierManagementPage extends BasePage {
    ...
    public supplierDetails = `//span[@class='ml-2' and normalize-space(text())='Suppliers']`;
    // Methods
    ...
    public async isSupplierDetailsDisplayed(): Promise<boolean> {
        return this.page.isVisible(this.supplierDetails);
    }
