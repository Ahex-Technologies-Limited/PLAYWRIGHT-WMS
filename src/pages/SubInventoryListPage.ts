...
export class SubInventoryListPage extends BasePage {
  ...
  public subInventoryNameInput = `//input[@formcontrolname='name']`;
  public descriptionInput = `//textarea[@formcontrolname='description']`;
  public subInventoryTypeSelect = `//p-dropdown[@formcontrolname='type']`;
  public capacityInput = '//*[@formcontrolname="capacity"]';
  public measurementUnits = `//p-dropdown[@formcontrolname='measurement_unit']`;
  ...
  public statusSelect = `//p-dropdown[@formcontrolname='status']`;
  public temperatureControlledSelect = `//p-dropdown[@id='temperature_controlled']`;
