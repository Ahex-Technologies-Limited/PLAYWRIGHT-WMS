...
import { PlaywrightBrowserHelper } from '../helpers/lib/PlaywrightBrowserHelper';
...
export class QuotationPage extends BasePage {
  ...
  //Selectors
  public quotationSideBar = `//div[@id='pn_id_406_15_header']//a[@class='p-panelmenu-header-action ng-tns-c147418153-78 ng-star-inserted']`;
  ...
  public async clickOnQuotationSideBar() {
    // await this.page.waitForSelector(`//div[@id='pn_id_23_15_header']//a[@href='#/admin/quotation/list']`);
    // const element = await this.page.locator(`//div[@id='pn_id_23_15_header']//a[@href='#/admin/quotation/list']`);
